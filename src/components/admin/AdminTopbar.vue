...
const sectionLabel = computed(() => ({ resumen: 'Resumen', negocios: 'Mis negocios', estadisticas: 'Estadísticas', mensajes: 'Mensajes', resenas: 'Reseñas', ajustes: 'Ajustes', perfil: 'Perfil', soporte: 'Soporte' }[props.section] ?? props.section))
