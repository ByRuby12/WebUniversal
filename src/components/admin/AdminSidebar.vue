...
<template>
  <aside class="sidebar" :class="{ 'sidebar-is-collapsed': collapsed }">
    <div class="sidebar-brand"><div class="wordmark"><span><BriefcaseBusiness :size="18" /></span><strong>UniversalWorks</strong></div></div>
